"""
Train Ads subagent with domain-specific research.

This script:
1. Uses SkillSelector.research_domain_specific() for Ads
2. Finds specialized repos (e.g., yandex-ads-mcp)
...
async def main():
    """Train Ads subagent with domain-specific research."""
    logger.info("ads_training_start")
    ...
    logger.info("phase_1_research", subagent="ads")
    ...
    print("\n" + "="*80)
    print("ADS SUBAGENT - DOMAIN-SPECIFIC RESEARCH RESULTS")
    print("="*80 + "\n")
    ...
    logger.info("phase_2_analysis", subagent="ads")

    # Get top 3 repos by stars across all queries
    ...
    print("\n" + "="*80)
    print("TOP 3 REPOS FOR ANALYSIS")
    print("="*80 + "\n")
    ...
    for repo in top_repos:
        try:
            ...
            clone_path = Path(f"/tmp/teacher_repos/ads/{repo_name}")

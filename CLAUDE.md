...
- **CRITICAL: Работаем ТОЛЬКО в коммерческой медицине.**
  - Никаких государственных, муниципальных, бюджетных учреждений (ГАУЗ, ГБУЗ, ГУЗ, МУЗ, МБУЗ)
  - Никаких городских/районных/областных поликлиник и больниц
  - Никаких диспансеров, ЦРБ, женских консультаций, станций скорой помощи
  - Только: ООО, АО, ЗАО, ИП — частные коммерческие клиники и медицинские центры
  - Фильтрация реализована в `competitor_matcher.py:_is_state_healthcare()`

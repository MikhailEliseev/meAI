...
- Name: onboarding-flow.spec.ts >> Document Upload and AI Processing >> should display extracted data from clinic info
- Location: e2e/onboarding-flow.spec.ts:54:7

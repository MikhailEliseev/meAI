...
- Name: onboarding-flow.spec.ts >> Document Upload and AI Processing >> should display onboarding page with upload areas
- Location: e2e/onboarding-flow.spec.ts:22:7

...
- Name: onboarding-flow.spec.ts >> BAA Signature Workflow >> should display BAA signature section after documents uploaded
- Location: e2e/onboarding-flow.spec.ts:200:7

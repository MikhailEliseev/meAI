            ...
            if not formatted_shown and (
                ...
                messages.append({
                    ...
                    "content": (
                        ...
                        "**💡 Позиция:** 2-3 предложения — лидер/середняк/аутсайдер рынка. "
                        "Сравни клиента с каждым конкурентом по выручке. Назови цифры.\n\n"
                        "**✅ Сильные:** 3-4 пункта. Что лучше конкурентов? С цифрами. "
                        "Назови имена врачей если найдены.\n\n"
                        "**⚠️ Рост:** 3-4 конкретных пробела. Где отстаёте от конкурентов? "
                        "С цифрами. НЕ рекомендуй то что уже есть.\n\n"
                        "**🖥️ Сайт:** 2-3 пункта. Что технически не так? Используй данные "
                        "аудита: GEO Score, MedicalBusiness Schema (есть/нет), meta description "
                        "(есть/нет), Open Graph (есть/нет), скорость загрузки, CMS. "
                        "Для КАЖДОЙ проблемы — конкретное «что сделать».\n\n"
                        "**📱 Соцсети:** 2-3 пункта. Что есть (VK, Telegram), чего нет. "
                        "Сравни с конкурентами (у них IG X подписчиков, у вас — что?). "
                        "Где отставание? Что развивать?\n\n"
                        "**🗣️ Отзывы:** 2-3 предложения — главные темы. Назови рейтинг.\n\n"
                        "**🎯 Рекомендации:** 2-3 действия на основе РЕАЛЬНЫХ пробелов "
                        "из пунктов выше. Конкретно и измеримо.\n\n"
                        "[SUGGESTIONS]\n"
                        "📸 Анализ соцсетей конкурентов|run_instagram_content\n"
                        "🔍 Глубокий SEO-аудит сайта|seo_audit\n"
                        "[/SUGGESTIONS]\n\n"
                        "КРИТИЧНО — ИСПОЛЬЗОВАНИЕ ДАННЫХ:\n"
                        "- В анализе ОБЯЗАТЕЛЬНО упомяни КАЖДОГО конкурента из таблицы (по имени) "
                        "и его выручку/прибыль. Не игнорируй конкурентов «в середине» списка.\n"
                        "- Сравнивай клиента с конкурентами в X раз / на Y млн — с цифрами.\n"
                        "- НЕ копируй таблицу строка-в-строку — пиши ВЫВОДЫ, но с цифрами из неё.\n\n"
                        "ПРАВИЛА:\n"

...
## Iron Rule 4 — Political Firewall

Абсолютный запрет на сбор, хранение и упоминание ЛЮБОЙ политической информации. Цель — медицинский маркетинг, не политический анализ.

**ЖЁСТКИЙ ФИЛЬТР — НЕ ПРОНИКАЕТ В data.json:**

- ❌ Политические affiliations врачей/клиник (членство в партиях, движениях, объединениях)
- ❌ Политический активизм (подписание петиций, участие в акциях, публичные заявления)
- ❌ Оппозиционная деятельность любого рода
- ❌ Политические должности (депутат, член общественной палаты — если обнаружено, НЕ записывать)
- ❌ Политические скандалы, расследования, упоминания в политическом контексте
- ❌ Донорство/сборы, связанные с политическими организациями
- ❌ Любые связи врача/клиники с политическими фигурами

**Что остаётся (ТОЛЬКО профессиональное):**

- ✅ Медицинские степени, звания, сертификации
- ✅ Научные публикации, исследования, монографии
- ✅ Профессиональные конференции и конгрессы (медицинские)
- ✅ Клинический опыт, стаж, специализация
- ✅ Профессиональные награды и признание в медицине
- ✅ Членство в профессиональных медицинских ассоциациях

**При обнаружении политического контента:**
1. НЕ записывать в data.json
2. НЕ комментировать — просто пропустить
3. НЕ задавать уточняющих вопросов пользователю про политический контекст
4. Продолжить сбор профессиональных данных как ни в чём не бывало

**Почему:** AIM — агентство медицинского маркетинга. Политическая информация токсична для коммерческого пресейла, создаёт риски для клиентов и агентства, и не имеет отношения к маркетинговой ценности врача или клиники. Полная изоляция: политические данные не пересекают границу пайплайна.
...
```json
{
  ...
  "social_profiles": {
    "instagram": {"username": "<username>", "followers": "<N>"},
    "vk": {"url": "https://vk.com/...", "followers": "22 400"},
    "telegram": ["@<username>"]
  },
  "media_mentions": [
    {"source": "<издание>", "title": "<заголовок>", "url": "<url>", "date": "<дата>"},
    {"source": "<издание>", "title": "<заголовок>", "url": "<url>", "date": "<дата>"}
  ],
  "conferences": ["<название конференции>", "<год>"],

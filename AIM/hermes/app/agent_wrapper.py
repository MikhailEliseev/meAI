...
- **run_prescan** — начни с быстрого среза. Покажи что увидел: специализацию, город, врачей, оборот. Сразу дай SEO-косяки из seo_issues списка. Для скорости загрузки используй ТОЛЬКО поле web_speed — оно уже содержит готовую человеческую оценку (например «1.1 сек — хорошая скорость»). НЕ вычисляй скорость сам из load_speed_ms, НЕ придумывай свои цифры. Расскажи про отзывы: «47 отзывов, рейтинг 4.3 — хвалят врачей, жалуются на очереди». Покажи соцсети: «Последний пост в VK — 3 дня назад».

...
«Хотите, я найду 3 похожие клиники для сравнения? Подберу по обороту, услугам и локации — как раз те, с кем вы реально конкурируете за пациентов.»
...
«Вот 3 клиники, похожие на вашу:

1. [Название] — [Город], выручка ~[сумма]/год
   Услуги: [список]
   Почему: [match_reason]
...
- find_competitors — найти 3 конкурентов (шаг 4)

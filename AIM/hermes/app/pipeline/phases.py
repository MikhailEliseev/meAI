...
PHASE_3_SOCIAL = Phase(
    ...
    interpretation_prompt=(
        ...
        "Сравни с конкурентами из Perplexity-контекста. "
...
PHASE_4_CONTENT = Phase(
    ...
    llm_interpret=True,
    interpretation_prompt=(
        "Проанализируй контент сайта клиники. Оцени его против конкурентов из Perplexity-контекста. "
        "Выдели: (1) сильные страницы, "
...
PHASE_6_SMI = Phase(
    ...
    interpretation_prompt=(
        ...
        "Учитывай, что это клиника в городе {client_city}, специализация — {client_specialization}. "
        "Оцени медийный охват относительно конкурентов из Perplexity-контекста. "

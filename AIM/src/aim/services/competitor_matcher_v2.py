...
3. ТОЛЬКО в том же населённом пункте: {city}. НЕ давай клиники из других городов области (не Москва, не Химки, не Подольск — ТОЛЬКО {city}).
...
SIMPLE_DISCOVERY_PROMPT = """Назови 12 самых известных клиник {specialization} ТОЛЬКО в городе {city} (не в области, не в Москве — именно {city}).

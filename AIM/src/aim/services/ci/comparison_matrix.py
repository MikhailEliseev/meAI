    ...
    def build(
        ...
        for idx, cf in enumerate(competitors_full, start=1):
            comp = {
                ...
                "yandex_rating": cf.yandex_rating,
                "yandex_reviews_count": cf.yandex_reviews_count,
                "prodoctorov_rating": cf.prodoctorov_rating,
                "prodoctorov_reviews_count": cf.prodoctorov_reviews_count,
